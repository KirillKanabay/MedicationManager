...
{
    public class DeliveryControlViewModel : BaseStockControlViewModel<DeliveryModel, DeliveryDto>
    {
        public DeliveryControlViewModel(StockDialogFactory dialogFactory, IMapper mapper, ViewModelLocator viewModelLocator, ISnackbarMessageQueue messageQueue, IDeliveryService service) : base(dialogFactory, mapper, viewModelLocator, messageQueue, service)
        {
        }
